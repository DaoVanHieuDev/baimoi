...
export const updatePayment = async (id: number) => {
  return db.execute(
    `UPDATE project_jbl.order_cart SET status = '0' WHERE (order_cart_id = ?)
  `,
    [id]
  );
};
...
export const getAllOrder = async () => {
  return db.execute(`SELECT  o.userId , o.detailId, o.numberBuy, o.nameGlass, o.price, o.orderDate, oc.order_cart_id, oc.status, u.username FROM project_jbl.order as o 
