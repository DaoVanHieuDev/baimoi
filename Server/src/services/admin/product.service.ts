...
export const editOne = async (
  ...
  return db.execute(
    `UPDATE project_jbl.glasses SET glassName = ?, glassPrice = ?, materialId = ?, styleId = ?, glassSale = ? WHERE (glassId = ?)
  `,
...
export const creatOne = async (
  ...
  return db.execute(
    `INSERT INTO project_jbl.glasses (glassName, glassPrice, materialId, styleId, glassSale) VALUES (?, ?, ?, ?, ?)
  `,
...
export const createDetail = async (
  ...
  return db.execute(
    `INSERT INTO project_jbl.detail (glassId, color, quantity, rgb) VALUES (?, ?,?,?)
  `,
...
export const createMedia = async (mediaList: any, insertId: number) => {
  return db.execute(
    `INSERT INTO project_jbl.media ( glassId, img1, img2, img3, img4) VALUES (?,? ,?,?,?) `,
